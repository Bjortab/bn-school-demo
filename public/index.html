...
Kunna nämna två viktiga händelser."
        ...
        <div class="form-group">
          <label for="max-chapters-select">Max antal kapitel</label>
          <select id="max-chapters-select">
        ...
        <div class="form-group">
          <label for="chapter-length-select">Kapitel-längd</label>
          <select id="chapter-length-select">
            <option value="kort">Kort</option>
            <option value="normal" selected>Normal</option>
            <option value="lang">Lång</option>
          </select>
          <small class="hint-text">Tips: “Lång” får vara rejält längre än tidigare.</small>
        </div>
      </div>
    ...
    <section id="student-panel" class="panel hidden">
      ...
      <p class="panel-intro">Eleven skriver sin idé, BN-Skola väver ihop den med lärarens fakta.</p>

      <section id="lesson-summary" class="lesson-summary"></section>

      <div class="form-grid student-grid">
        <div class="form-group">
          <label for="student-name-input">Elevens namn (valfritt)</label>
          <input id="student-name-input" type="text" placeholder="Ex: Alex" />
        </div>
        ...
        <div class="form-group">
          ...
          <textarea
            ...
            rows="3"
            placeholder="Ex: Vi vaknar i en skog där Zeus har tappat sin åskvigg, och vi måste hjälpa honom hitta den."
          ></textarea>
          <small class="hint-text">
            Tips: BN-Kids-stil: prompten används för att “starta”. Låt den gärna ligga kvar – nästa kapitel fortsätter ändå framåt.
          </small>
        </div>
      </div>
      ...
      <div class="chapter-tools">
        <label for="chapter-select"><strong>Visa kapitel:</strong></label>
        <select id="chapter-select"></select>
        <span id="chapter-counter" class="chapter-counter"></span>
      </div>
  ...
  <div id="loading-overlay" class="loading-overlay hidden" aria-hidden="true">
    ...
    <div class="loading-text">Skapar kapitel…</div>
  </div>

  <footer class="app-footer">
    <small>BN-Skola v1 – demo för Region Dalarna</small>
  </footer>
